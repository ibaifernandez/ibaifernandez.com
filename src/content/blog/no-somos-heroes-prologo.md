...
Así que la pregunta sigue estando vigente: ¿Quién eres verdaderamente? «Cómo eres» tampoco dirá quién eres (pues el quién y el cómo atienden a dos aspectos diferentes de un mismo concepto). Así que esto se convierte en un **uróboro** (que, a fin de cuentas, es exactamente como el budismo, a expensas de la que pueda llegar a ser la realización espiritual definitiva — el ínclito _nirvana_ — concibe el mundo en el que vivimos.
